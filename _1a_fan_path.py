...
# --------------------------------------------------
# Project root (auto-detect by file location)
#
# Used by:
# - _1_fan_GUI.py
# - _1d_XYZ_Output.py
# - _1e_step_Algorithm.py
# - _1f_Blade_Viewer.py
# --------------------------------------------------
...
JSON_DIR  = os.path.join(INPUT_DIR, "1_Blade_Parameters")
TEMPLATE_JSON = os.path.join(JSON_DIR, "template.json")
...
# - STEP
# --------------------------------------------------
OUTPUT_DIR = os.path.join(PROJECT_ROOT, "2_Output","1_Blade")
